...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/hepstats-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11692&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/hepstats-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `hepstats` can be installed with:

```
conda install hepstats
```

It is possible to list all of the versions of `hepstats` available on your platform with:
